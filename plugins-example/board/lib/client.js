...
function PlaceholderPage() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "p-10 max-w-lg", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-lg font-bold mb-3", children: "\u5361\u7247\u770B\u677F \u63D2\u4EF6" }),
...
function registerClient(ctx) {
  ctx.registerNav({ id: "board", label: "\u5361\u7247\u770B\u677F", icon: "FolderKanban", order: 80 });
  ctx.registerRoute("board", () => Promise.resolve({ default: PlaceholderPage }));
}
